...
if [ "$MESH_ROLE" = "gateway" ]; then
    REQUIRED_PKGS="$REQUIRED_PKGS adguardhome bind-dig dnsmasq-full luci-proto-wireguard luci-app-pbr luci-i18n-pbr-zh-tw luci-app-ddns luci-i18n-ddns-zh-tw qosify"
fi
